...
#===============================================================================
#
#          FILE: biqui-sweep-ratios-delays.sh
# 
#         USAGE: ./biqui-sweep-ratios-delays.sh 
# 
#   DESCRIPTION: 
# 
#       OPTIONS: ---
...
target_d=$1
reliab=$2
biqui=$3 # 1|0 to issue/not BiQui
opt=$4 # 1|0 to issue/not OPT
    ...
    for rec in $recs; do
        ...
        for del_edge in `echo $dels_edge`; do
            ...
            if [ $biqui -eq 1 ]; then
                ...
                results="results/journal-extension/$experiment.csv"
            ...
            if [ $opt -eq 1 ]; then
                ...
                results_opt="../results/journal-extension/$experiment_opt.csv"
