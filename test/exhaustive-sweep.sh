...
#===============================================================================
#
#          FILE: exhaustive-sweep.sh
# 
#         USAGE: ./exhaustive-sweep.sh 
# 
#   DESCRIPTION: 
# 
#       OPTIONS: ---
...
results="exhaustive-targetd_$target_d-reliab_$reliab-mode_$mode-$now.csv"
...
for lam in `seq $lam_min $lam_step $lam_max`; do
    log_f="logs/exhaustive-reliab-$reliab-targetdel-$target_d-lambda-`printf '%.2f' $lam`-mu-`printf '%.2f' $mu`-mode_$mode.log"
